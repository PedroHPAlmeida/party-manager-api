...
public class ServiceProviderService {
    ...
    public ServiceProviderResponseDTO addServiceProviderToEvent(Long eventId, ServiceProviderRequestDTO requestDTO) {
        ...
        Event event = eventRepository.findById(eventId).orElseThrow(() -> new ResourceNotFoundException("Evento não encontrado com ID: " + eventId));
    ...
    public void removeServiceProviderFromEvent(Long eventId, Long serviceProviderId) {
        ...
        ServiceProvider serviceProvider = serviceProviderRepository.findById(serviceProviderId).orElseThrow(() -> new ResourceNotFoundException("Provedor de serviço não encontrado com ID: " + serviceProviderId));
